		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicacion Destino",
									"targetURL": "#comtasamodule2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtasamodule2-display": {
								"semanticObject": "comtasamodule2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.module2",
									"url": sap.ui.require.toUrl("com/tasa/module2")
								}
							}
						}
					}
